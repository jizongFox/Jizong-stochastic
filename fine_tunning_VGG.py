...
cmd4 = '''
python main.py --lr 0.0001 --resume --resume_from conventional_scheme_VGG --resume_to conventional_scheme_VGG --epochs_to_train 200
'''
os.system(cmd4)

cmd5 ='''
python main.py --lr 0.000099 --resume --resume_from conventional_scheme_VGG --resume_to fine-tunning_VGG --loss_function stochastic --normalize --epochs_to_train 5000
'''
os.system(cmd5)
